...
export function getClassesForState(state: State, props: TransitionClasses) {
	switch (state) {
	case State.BeforeEnter: return merge(props.enterFrom);
	case State.Entering: return merge(props.enter, props.enterTo);
	case State.BeforeExit: return merge(props.exitFrom, props.invertExit && props.enterTo);
	case State.Exiting: return merge(props.exit, props.exitTo,
		props.invertExit && props.enter, props.invertExit && props.enterFrom);
	default: return '';
	}
}
