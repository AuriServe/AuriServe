				...
				{(selected) => (
					<Fragment>
						<MediaIcon
							path={media.url}
							class={merge(
								'flex-shrink-0 group-hover:bg-neutral-200 dark:group-hover:bg-neutral-700',
								!selected && '!icon-p-neutral-400 dark:!icon-p-neutral-200',
								!selected && '!icon-s-neutral-300 dark:!icon-s-neutral-500',
								selected &&
									'!bg-accent-200 dark:!bg-accent-900/50 !icon-p-accent-600 !icon-s-accent-400 dark:!icon-p-accent-200'
							)}
						/>
						...
						<div class='pl-1 text-left overflow-hidden'>
							...
							<p
								class={merge(
									'text-sm pt-0.5 truncate font-medium',
							...
							<p
								class={merge(
									'text-sm pt-1 truncate font-normal',
									selected ? 'text-accent-800/75 dark:text-accent-300' : 'text-neutral-500 dark:text-neutral-200'
								)}>
