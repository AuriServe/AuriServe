...
// 								onValue={(id) => props.onChange((media ?? []).filter((media) => media.id === id)[0])}
// 							/>
// 						);
...
// 						return (
// 							<span>
// 								Custom props can't be edited by the builtin element editor. Use a custom editElement until this is
// 								implemented.
// 							</span>
// 						);
// 				}
