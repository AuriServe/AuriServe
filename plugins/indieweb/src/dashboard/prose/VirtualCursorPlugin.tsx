import { Mark, ResolvedPos, Schema } from 'prosemirror-model';
import { EditorView, Decoration, DecorationSet } from 'prosemirror-view';
import { Plugin, PluginKey, TextSelection, Selection } from 'prosemirror-state';

/**
 * Based upon https://github.com/ocavue/prosemirror-virtual-cursor.
 * Copied over because the NPM package wouldn't resolve correctly when installed.
 */
...
export default function VirtualCursorPlugin(options?: VirtualCursorOptions): Plugin {
