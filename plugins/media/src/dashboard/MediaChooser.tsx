...
export default function MediaImageChooser(props: Props) {
	...
	return (
		<Modal active={props.active} onClose={props.onClose}
			class={tw`w-screen max-w-6xl grid-(& cols-[auto_32rem]) overflow-hidden`}>
			...
			<div class={tw`grid relative bg-gray-900/50`}>
				...
				<div
					class={tw`col-start-1 p-6 pt-0 pr-2.5 overflow-auto h-[calc(100vh-18rem)]
						grid-(& cols-3) gap-(x-6 y-4)
